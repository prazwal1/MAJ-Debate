...
\title{MAJ-Debate: Multi-Agent LLM Argumentation Framework\\
       for Automated Debate Judgment: Final Report}
...
\begin{tikzpicture}[
    ...
    stage/.style={rectangle, draw, rounded corners=4pt, text centered,
                  minimum height=1.0cm, minimum width=8cm, font=\small},
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig_running_example.png}
  \caption{Four-stage pipeline walkthrough for LOGIC\_002 (``penguins can
  fly''). The Dung graph correctly returns CON but the Stage~4 judge
  overrides the verdict to PRO, illustrating failure mode E3.}
  \label{fig:running}
\end{figure}
